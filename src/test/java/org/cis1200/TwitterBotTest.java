...
public class TwitterBotTest {
    ...
    @Test
    public void twitterBotSingleWord() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "hello"
                )
        ...
        StringReader sr = new StringReader(words);
        BufferedReader br = new BufferedReader(sr);
        TwitterBot tb = new TwitterBot(br, 0);

        String expected = "hello.";
        String actual = tb.generateTweet(1);
        assertEquals(expected, actual);
    }

    @Test
    public void twitterBotDuplicatesTest() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "hello", "cis1200", "world", "hello","!"
                )
        );
        String words = "0, simple test.\n"
                + "1, hello cis1200 world hello!\n"
                + "2, this is amazing.";
        StringReader sr = new StringReader(words);
        BufferedReader br = new BufferedReader(sr);
        TwitterBot t = new TwitterBot(br, 1);
        ...
        String expected = "hello cis1200 world hello!";
        String actual = t.generateTweet(4);
        assertEquals(expected, actual);
    }

    @Test
    public void twitterBotNegativeNumWordsTest() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "hello", "cis1200", "world", "!"
                )
    ...
    @Test
    public void twitterBotZeroNumWordsTest() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "hello", "cis1200", "world", "!"
                )
        ...
        String expected = "";
        String actual = t.generateTweet(0);
        assertEquals(expected, actual);
    }
