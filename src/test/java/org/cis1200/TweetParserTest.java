...
public class TweetParserTest {
    ...
    @Test
    public void testExtractColumnOutOfBounds() {
        assertEquals(
                null,
                TweetParser.extractColumn(
    ...
    @Test
    public void testCsvDataToTweetsColumnOutOfBounds() {
        StringReader sr = new StringReader(
                "0, The end should come here.\n" +
                        "1, This comes from data with no duplicate words!"
        );
    ...
    @Test
    public void testCsvDataToTweetsEmpty() {
        StringReader sr = new StringReader("");
        BufferedReader br = new BufferedReader(sr);
        List<String> tweets = TweetParser.csvDataToTweets(br, 1);
        List<String> expected = new LinkedList<String>();
    ...
    @Test
    public void parseAndCleanSentenceEmptyFiltered() {
    ...
    @Test
    public void testParseAndCleanTweetEmpty() {
        List<List<String>> sentences = TweetParser
                .parseAndCleanTweet("");
        List<List<String>> expected = new LinkedList<List<String>>();
        assertEquals(expected, sentences);
    ...
    @Test
    public void testCsvDataToTrainingDataSimpleCSVEmpty() {
        StringReader sr = new StringReader(
                "0, The end should come here.\n" +
                        ""
        );
